...
3. You can't write inlines styles in JSX. You have to reference an object in scope or pass an object that contains CSS properties, written as JS properties (e.g. `style={{color:"red"}}`).
