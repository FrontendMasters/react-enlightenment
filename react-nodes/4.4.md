...
In one sense you can think of props as the configuration options for React nodes/components and in another sense you can think of them as HTML attributes.
