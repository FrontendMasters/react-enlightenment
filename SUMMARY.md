...
* [React Nodes](react-nodes.md)
    ...
    * [Rendering React nodes to DOM](react-nodes/2.3.md)
    * [Defining React node attributes (aka props)](react-nodes/2.4.md)
    * [Using React node element factories](react-nodes/2.5.md)
* [JavaScript Syntax Extension (aka JSX)](react-jsx.md)
    ...
    * [Defining attributes (aka props) in JSX](react-jsx/3.7.md)
