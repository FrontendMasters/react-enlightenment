...
* [Basic React components](basic-react-components.md)
	...
	* [Getting & setting props](basic-react-components/6.6.md)
	* [Getting & setting state](basic-react-components/6.7.md)
	* [Using the component API](basic-react-components/6.8.md)
* [React Props](react-props.md)
    * [What are props?](/7.1.md)
* [React State](react-state.md)
    * [What is state?](/8.1.md)
    * [state v.s. props](/8.2.md)
