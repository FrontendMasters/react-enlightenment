...
* [React Setup](template.md)
    ...
    * [Transform JSX to JavaScript using Babel via SystemJS during development](template.md)
    * [Transform JSX to JavaScript using Babel via WebPack during development](template.md)
