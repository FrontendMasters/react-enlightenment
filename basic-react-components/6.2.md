...
The most important component configuration option is `render`. This confirmation option is required and is a function that returns React nodes. All other component configurations are optional.
