...
With the `react.js` file and `react-dom.js` file loaded into an HTML page it is then possible to create React elements/components and then render them to the DOM.
...
This setup is all you need to use React. However this setup does not make use of JSX.   
